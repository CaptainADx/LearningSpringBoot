...
public class MedicalStoreController {
    ...
    public List<MedicalStore> getNearestMedicalStores(@PathVariable Long userId, @PathVariable Long distance, @PathVariable String token){
        return medicalStoreService.getNearestMedicalStores(userId, distance, token);
    }

    @GetMapping("/getStoresWithMedicine/{medicine}/{token}")
    public List<MedicalStore> getMedicalStoresHavingMedicine(@PathVariable String medicine, @PathVariable String token){
        return medicalStoreService.getMedicalStoresHavingMedicine(medicine, token);
    }
