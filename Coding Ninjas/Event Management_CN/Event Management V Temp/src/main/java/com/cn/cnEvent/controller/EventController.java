...
public class EventController {
	...
	public List<Ticket> getAllTicketsByEventId(@PathVariable Long eventId){
		return eventService.getAllTicketsByEventId(eventId);
	}
	
	@GetMapping("/tickets/PriceGreaterThan/{price}")
	public List<Event> getAllEventsByTicketPrice(@PathVariable Long price){
		return eventService.getAllEventsByTicketPrice(price);
	}
