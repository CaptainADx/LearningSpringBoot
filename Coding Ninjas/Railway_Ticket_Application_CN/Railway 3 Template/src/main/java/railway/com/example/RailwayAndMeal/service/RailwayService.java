...
public class RailwayService{
	...
	**/
		if(ObjectUtils.isEmpty(ticketMap.get(pnr))) {
			throw new TicketNotFoundException("No ticket found for PNR : " + pnr);
		}
	...
	**/
		if(!ObjectUtils.isEmpty(ticketMap.get(ticket.getPnr()))) {
			throw new TicketAlreadyExistsException("The ticket with PNR - " + ticket.getPnr() + " already exists");
		}
	...
	public void deleteTicketByPnr(long pnr) {
		...
		if(ObjectUtils.isEmpty(ticket)) {
			throw new TicketNotFoundException("The ticket with PNR : "+ pnr + " does not exists.");
		}
	...
	public void updateTicket(Ticket ticket) {
		...
		if(ObjectUtils.isEmpty(existing_ticket)) {
			throw new TicketNotFoundException("The ticket with PNR : "+ ticket.getPnr() + " does not exists.");
		}
