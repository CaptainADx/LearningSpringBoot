...
public class MealServiceCommunicator {
	...
	public void deleteMeal(Long pnr) {
		...
		restTemplate.exchange(url+pnr, HttpMethod.DELETE, null, Object.class);
	}
	...
	**/
	public void updateMeal(Meal meal) {
		...
		HttpEntity<Meal> requestEntity = new HttpEntity<Meal>(meal);
		restTemplate.exchange(url+meal.getPnr(), HttpMethod.PUT, requestEntity, Object.class);
