...
public class Car implements Vehicle {
    ...
    **/ 
    ...
    public int saveVehicleDetails() {
        if(RegisterationNumber!=null && !RegisterationNumber.equals("") && CarName!=null && !CarName.equals("") && CarDetails!=null && !CarDetails.equals("")){
    ...
    @Override
    public void createVehicle(String RegisterationNumber, String CarName,String CarDetails,String CarWork ) {
